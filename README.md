...
> * [TCP/IP, ISO/OSI, UDP/TCP](networking/tcp-ip.md) — *Protocol layers, subnets, encapsulation and so on.*
...
> [!IMPORTANT]
> ### TryHackMe & Labs
> * [OpenVPN & Lab Setup](tryhackme/openvpn-setup.md) — *Tünel bağlantısı sorun giderme*
